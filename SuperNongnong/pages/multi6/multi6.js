...
Page({
   ...
   */
  data: {
    corpus: "3的平方加8再乘以6再除以2等于几|5的平方根|6的七次方|99的三倍|19的三分之一是多少|77的…17个9|12的对数|23的自然对数|5加六加七再乘10|三只苹果加五只苹果等于几只苹果|19加7",
    //调试后门
    isDbg: false,
    //输入框文本
    inputTxt: '',
  ...
  onPullDownRefresh: function () {
    UTIL.log('multi.onPullDownRefresh')
  ...
  onShareAppMessage: function () {
    UTIL.log('multi.onShareAppMessage')
  ...
  switchChange: function (e) {
    UTIL.log('multi.switchChange by:' + e.detail.value)
  },

  //输入文本框聚焦触发清除输入框中的内容
  bindFocusClear: function (e) {
    UTIL.log('multi.bindFocusClear')
    if (e.detail.value === '') {
      return;
    }
  ...
  bindConfirmControl: function (e) {
    ...
    UTIL.log('multi.bindConfirmControl input string: ' + inputTxt);
  ...
  bindCorpusGenerator: function (e) {
    UTIL.log('multi.bindCorpusGenerator')
    //获取"data-cp"中的语料
...
function selectCorpusRunNli(self) {
  var corpus = self.data.corpus.split('|');
